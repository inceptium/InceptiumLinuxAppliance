...
do
	...
	java -Xms128m -Xmx256m -cp "InceptiumServices.jar:/root/InceptiumLinuxAppliance/InceptiumServices/lib/*:/root/InceptiumLinuxAppliance/InceptiumServices/InceptiumApp/*" inceptiumserver.core.server.IncServer noswing updatedatabase landevice=eth0 storage=$DATASTORAGE >> $LOGFILE 2>&1
        MSG=$?
