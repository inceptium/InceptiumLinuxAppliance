...
do
	...
	java -Xms128m -Xmx256m -cp "InceptiumServices.jar:/root/InceptiumLinuxAppliance/InceptiumServices/lib/*" inceptiumserver.core.server.IncServer noswing updatedatabase landevice=eth0 storage=$DATASTORAGE appstore=$DATASTORAGE/InceptiumAppStore >> $LOGFILE 2>&1
        MSG=$?
